...
```bash
# 1. Subir SQL Server e a stack de observabilidade
docker compose up -d
...
Os testes usam EF Core InMemory — **não precisam de Docker**. Para rodar contra um SQL Server
real, o pacote `Testcontainers.MsSql` já está referenciado: descomente o container em
